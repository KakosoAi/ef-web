  ...
  useEffect(() => {
    const handleShowEquipmentDetail = (event: CustomEvent) => {
      const equipment = {
        ...
        description: "This premium heavy equipment is in excellent condition and ready for immediate deployment. Features advanced hydraulic systems, comfortable operator cabin with climate control, and comprehensive safety features. Recently serviced and comes with maintenance records.",
        specifications: {
