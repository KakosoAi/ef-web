...
const FeaturedEquipment = memo(() => {
  ...
  const handleContactDealer = useCallback((dealerName: string) => {
    // Handle contact dealer action
    console.log('Contact dealer:', dealerName);
  }, []);

  const handleToggleFavorite = useCallback((id: number) => {
    // Handle toggle favorite action
    console.log('Toggle favorite for equipment:', id);
  }, []);
            ...
            <div key={equipment.id} className="card-featured group">
              ...
              <div className="p-6">
                ...
                <Button 
                  ...
                  onClick={() => window.dispatchEvent(new CustomEvent('showEquipmentDetail', { detail: equipment }))}
                >
                  View Details
