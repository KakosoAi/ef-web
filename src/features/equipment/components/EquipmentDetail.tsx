...
const EquipmentDetail = memo(({ equipment, onClose }: EquipmentDetailProps) => {
  ...
  const handleShare = useCallback(() => {
    ...
    console.log('Share equipment:', equipment.id);
  }, [equipment.id]);

  const handleContactDealer = useCallback(() => {
    // Handle contact dealer functionality
    console.log('Contact dealer for equipment:', equipment.id);
  }, [equipment.id]);
          ...
          <div className="space-y-6">
            ...
            <div className="bg-card rounded-xl border border-border p-6 sticky top-24">
              ...
              <div className="space-y-3">
                <Button className="w-full bg-primary hover:bg-primary-hover text-primary-foreground" size="lg" onClick={handleContactDealer}>
                  <Phone className="h-4 w-4 mr-2" />
                  Call Dealer
                </Button>
                <Button variant="outline" className="w-full" size="lg" onClick={handleContactDealer}>
