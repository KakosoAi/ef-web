  ...
  return (
    <div className='relative shrink-0 w-full'>
      <div className='flex items-center p-1 w-full'>
        <div className='h-10 w-8 flex items-center justify-center pl-2 text-foreground'>
...
function AvatarCircle() {
  return (
    <div className='relative rounded-full shrink-0 size-8 bg-background border border-border'>
          ...
          items: [
            {
              ...
              hasDropdown: true,
              children: [
                { label: 'All Listings', path: '/admin/ads' },
                { label: 'Create New Ad', path: '/admin/ads' }, // Pointing to ads page for now
              ],
            },
            {
              ...
              label: 'Inquiries',
              hasDropdown: true,
              children: [{ label: 'Recent Inquiries', path: '/admin/inquiries' }],
            },
            {
              ...
              hasDropdown: true,
              children: [
                { label: 'Published Posts', path: '/admin/blogs' },
                { label: 'Create Post', path: '/admin/blogs' },
              ],
            },
          ],
        },
...
function IconNavigation({
  ...
  return (
    <aside className='bg-background/80 backdrop-blur-md flex flex-col gap-2 items-center p-4 w-16 h-full border-r border-border rounded-l-2xl'>
      {/* Logo */}
      <div className='mb-2 size-10 flex items-center justify-center text-primary'>
...
function DetailSidebar({
  ...
  const toggleCollapse = propsOnToggleCollapse || (() => setInternalIsCollapsed(s => !s));
      ...
      {!isCollapsed && (
        <div className='w-full mt-auto pt-2 border-t border-border'>
          <div className='flex items-center gap-2 px-2 py-2'>
            <AvatarCircle />
            <div className="font-['Lexend:Regular',_sans-serif] text-[14px] text-foreground">
              Admin User
            </div>
            <button
              type='button'
              className='ml-auto size-8 rounded-md flex items-center justify-center hover:bg-muted text-muted-foreground hover:text-foreground'
              aria-label='More'
            >
    ...
    >
      <div
        className={`rounded-lg cursor-pointer transition-all duration-500 flex items-center relative ${
          item.isActive ? 'bg-primary/10 text-primary' : 'hover:bg-muted text-foreground'
      ...
      >
        <div
          className={`flex items-center justify-center shrink-0 ${item.isActive ? 'text-primary' : 'text-foreground'}`}
        >
          {item.icon}
        </div>
        ...
        {item.hasDropdown && (
          ...
          >
            <ChevronDownIcon
              size={16}
              className='transition-transform duration-500 text-muted-foreground'
              style={{
    ...
    <div className='w-full pl-9 pr-1 py-[1px]'>
      ...
      >
        <div className='flex-1 min-w-0'>
          <div className="font-['Lexend:Regular',_sans-serif] text-[14px] text-muted-foreground hover:text-foreground leading-[18px] truncate">
            {item.label}
          </div>
        </div>
      </div>
...
export function AdminSidebar({ userRole, isCollapsed, onToggleCollapse }: AdminSidebarProps) {
