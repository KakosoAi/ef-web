        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-primary-foreground/80 mb-8 max-w-2xl mx-auto">
              Get notified about new equipment listings, industry news, and exclusive deals from verified dealers
            </p>
          ...
          <div>
            ...
            <div>
              ...
              <div className="flex space-x-3">
                <Button key="facebook" size="sm" variant="ghost" className="p-2 hover:bg-primary-foreground/10">
                  <Facebook className="h-4 w-4" />
                </Button>
                <Button key="twitter" size="sm" variant="ghost" className="p-2 hover:bg-primary-foreground/10">
                  <Twitter className="h-4 w-4" />
                </Button>
                <Button key="instagram" size="sm" variant="ghost" className="p-2 hover:bg-primary-foreground/10">
                  <Instagram className="h-4 w-4" />
                </Button>
                <Button key="linkedin" size="sm" variant="ghost" className="p-2 hover:bg-primary-foreground/10">
